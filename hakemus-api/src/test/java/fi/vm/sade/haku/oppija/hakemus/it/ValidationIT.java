...
public class ValidationIT extends IntegrationTestSupport {
    ...
    public void validateFixture() {
        ...
        assertEquals(validateApplication(applicationSystemFixture, applicationFixture).size(), 0);
    }
    ...
    public void validateUpdatedFixture() {
        ...
        assertEquals(validateApplication(applicationSystemFixture, applicationFixture).size(), 5);
    }
