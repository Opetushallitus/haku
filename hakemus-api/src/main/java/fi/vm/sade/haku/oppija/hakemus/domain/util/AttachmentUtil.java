...
public class AttachmentUtil {
    ...
    public static final Set<String> YO_OR_KV_YO_POHJAKOULUTUSKOODI = new HashSet<String>() {{
                ...
                for (String koodi : ao.getPohjakoulutusLiitteet()) {
                    ...
                    if (ApplicationUtil.hasBaseEducation(application, formId)) {
                        if (ao.isJosYoEiMuitaLiitepyyntoja()) {
                            if (YO_OR_KV_YO_POHJAKOULUTUSKOODI.contains(koodi) || !ApplicationUtil.hasBaseEducationYoOrKvYo(application)) {
