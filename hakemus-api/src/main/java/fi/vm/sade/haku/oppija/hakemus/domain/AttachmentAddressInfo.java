...
public class AttachmentAddressInfo {
    ...
    public AttachmentAddressInfo(I18nText attachmentName, String recipientName, AddressDTO addressDTO, OriginatorType originatorType, String originatorId) {
