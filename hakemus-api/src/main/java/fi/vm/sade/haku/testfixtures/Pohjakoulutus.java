...
public enum Pohjakoulutus {
    ...
    MUUALLA_KUIN_SUOMESSA_SUORITETTU_KORKEAKOULUTUTKINTO_AMMATTIKORKEAKOULUTUTKINTO_ARUBA("Muualla kuin Suomessa suoritettu korkeakoulututkinto, ammattikorkeakoulututkinto (Aruba)",
            getKoulutustausta(new KoulutustaustaEntry("pohjakoulutus_kk_ulk", "true"), new KoulutustaustaEntry("pohjakoulutus_kk_ulk_taso", "1"), new KoulutustaustaEntry("pohjakoulutus_kk_ulk_maa", "ABW"), new KoulutustaustaEntry("pohjakoulutus_kk_ulk_nimike", "amk"))),
    ...
    MUUALLA_KUIN_SUOMESSA_SUORITETTU_KORKEAKOULUTUTKINTO_ALEMPI_YLIOPISTOTUTKINTO_KANDIDAATTI_ARUBA("Muualla kuin Suomessa suoritettu korkeakoulututkinto, alempi yliopistotutkinto (kandidaatti) (Aruba)",
            getKoulutustausta(new KoulutustaustaEntry("pohjakoulutus_kk_ulk", "true"), new KoulutustaustaEntry("pohjakoulutus_kk_ulk_taso", "2"), new KoulutustaustaEntry("pohjakoulutus_kk_ulk_maa", "ABW"), new KoulutustaustaEntry("pohjakoulutus_kk_ulk_nimike", "kandi"))),
    ...
    MUUALLA_KUIN_SUOMESSA_SUORITETTU_KORKEAKOULUTUTKINTO_YLEMPI_AMMATIKORKEAKOULUTUTKINTO_ARUBA("Muualla kuin Suomessa suoritettu korkeakoulututkinto, ylempi ammatikorkeakoulututkinto (Aruba)",
            getKoulutustausta(new KoulutustaustaEntry("pohjakoulutus_kk_ulk", "true"), new KoulutustaustaEntry("pohjakoulutus_kk_ulk_taso", "3"), new KoulutustaustaEntry("pohjakoulutus_kk_ulk_maa", "ABW"), new KoulutustaustaEntry("pohjakoulutus_kk_ulk_nimike", "ylempi amk"))),
    ...
    MUUALLA_KUIN_SUOMESSA_SUORITETTU_KORKEAKOULUTUTKINTO_YLEMPI_YLIOPISTOTUTKINTO_MAISTERI_ARUBA("Muualla kuin Suomessa suoritettu korkeakoulututkinto, ylempi yliopistotutkinto (maisteri) (Aruba)",
            getKoulutustausta(new KoulutustaustaEntry("pohjakoulutus_kk_ulk", "true"), new KoulutustaustaEntry("pohjakoulutus_kk_ulk_taso", "4"), new KoulutustaustaEntry("pohjakoulutus_kk_ulk_maa", "ABW"), new KoulutustaustaEntry("pohjakoulutus_kk_ulk_nimike", "maisteri"))),
    ...
    MUUALLA_KUIN_SUOMESSA_SUORITETTU_KORKEAKOULUTUTKINTO_LISENSIAATTI_TOHTORI_ARUBA("Muualla kuin Suomessa suoritettu korkeakoulututkinto, lisensiaatti/tohtori (Aruba)",
            getKoulutustausta(new KoulutustaustaEntry("pohjakoulutus_kk_ulk", "true"), new KoulutustaustaEntry("pohjakoulutus_kk_ulk_taso", "5"), new KoulutustaustaEntry("pohjakoulutus_kk_ulk_maa", "ABW"), new KoulutustaustaEntry("pohjakoulutus_kk_ulk_nimike", "tohtori"))),
    MUUALLA_KUIN_SUOMESSA_SUORITETTU_KANSAINVALINEN_YLIOPPILASTUTKINTO_INTERNATIONAL_BACCALAUREATE_IB_TUTKINTO_RUOTSI("Muualla kuin Suomessa suoritettu kansainvälinen ylioppilastutkinto, International Baccalaureate (IB) -tutkinto",
    ...
    MUUALLA_KUIN_SUOMESSA_SUORITETTU_KANSAINVALINEN_YLIOPPILASTUTKINTO_EUROPEAN_BACCALAUREATE_EB_TUTKINTO_ARUBA("Muualla kuin Suomessa suoritettu kansainvälinen ylioppilastutkinto, European Baccalaureate (EB) -tutkinto",
            getKoulutustausta(new KoulutustaustaEntry("pohjakoulutus_yo_ulkomainen", "true"), new KoulutustaustaEntry("pohjakoulutus_yo_ulkomainen_tutkinto", "eb"), new KoulutustaustaEntry("pohjakoulutus_yo_ulkomainen_maa", "ABW"))),
    MUUALLA_KUIN_SUOMESSA_SUORITETTU_KANSAINVALINEN_YLIOPPILASTUTKINTO_REIFEPRUFUNG_RB_TUTKINTO_ARUBA("Muualla kuin Suomessa suoritettu kansainvälinen ylioppilastutkinto, Reifeprüfung (RB) -tutkinto",
            getKoulutustausta(new KoulutustaustaEntry("pohjakoulutus_yo_ulkomainen", "true"), new KoulutustaustaEntry("pohjakoulutus_yo_ulkomainen_tutkinto", "rp"), new KoulutustaustaEntry("pohjakoulutus_yo_ulkomainen_maa", "ABW"))),
    ...
    MUUALLA_KUIN_SUOMESSA_SUORITETTU_MUU_TUTKINTO_JOKA_ASIANOMAISESSA_MAASSA_ANTAA_HAKUKELPOISUUDEN_KORKEAKOULUUN_ARUBA("Muualla kuin Suomessa suoritettu muu tutkinto, joka asianomaisessa maassa antaa hakukelpoisuuden korkeakouluun (Aruba)",
            getKoulutustausta(new KoulutustaustaEntry("pohjakoulutus_ulk", "true"), new KoulutustaustaEntry("pohjakoulutus_ulk_suoritusmaa", "ABW"), new KoulutustaustaEntry("pohjakoulutus_ulk_nimike", "muu")));
