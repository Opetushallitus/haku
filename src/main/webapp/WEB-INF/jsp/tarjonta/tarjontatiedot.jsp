...
<div id="viewport">
    ...
    <div id="site">
        ...
        <div class="search">
            <form>
                <input type="text" name="text" required="required" value="${parameters.text}" class="haku"/>
        ...
        <section id="vapaasanahaku" class="content-container">
            ...
            <div class="grid16-12">
                ...
                <div class="tabs">
                    <a href="#" data-tabs-group="applicationtabs" data-tabs-id="haut" class="tab current"><span>Koulutuksia (<c:out
                            value="${searchResult.size}"/> kpl)</span></a>
                ...
                <section id="koulutuksia" class="tabsheets">
                    ...
                    <div class="grid16-10">
                        <h1>Hakusana: <c:out value="${parameters.text}"/></h1>
                        ...
                        <c:forEach var="item" items="${searchResult.items}">
                            <div class="form-row">
                                ...
                                <div class="set-right"><input type="checkbox"/><span
                                        class="label">Lisää muistilistaan</span>
                                </div>
                            </div>
                        </c:forEach>
