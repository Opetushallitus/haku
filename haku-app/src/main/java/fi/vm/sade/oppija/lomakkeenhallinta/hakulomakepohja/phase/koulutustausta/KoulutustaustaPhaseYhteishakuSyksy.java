...
package fi.vm.sade.oppija.lomakkeenhallinta.hakulomakepohja.phase.koulutustausta;
...
public final class KoulutustaustaPhaseYhteishakuSyksy {
    ...
    private KoulutustaustaPhaseYhteishakuSyksy() {
    }
