...
public final class KoulutustaustaPhaseSyksy {
    ...
    private KoulutustaustaPhaseSyksy() {
    }
    ...
    public static Phase create(final KoodistoService koodistoService, final String formMessagesBundle, final String formErrorsBundle, final String formVerboseHelpBundle) {
        ...
        koulutustaustaRyhma.addChild(createKoulutustaustaRadio(koodistoService,formMessagesBundle, formErrorsBundle, formVerboseHelpBundle));
    ...
    public static Radio createKoulutustaustaRadio(final KoodistoService koodistoService, final String formMessagesBundle, final String formErrorsBundle, final String formVerboseHelpBundle) {
        ...
        paattotodistusvuosiPeruskoulu.setValidator(
                createRegexValidator(paattotodistusvuosiPeruskoulu.getId(), PAATTOTODISTUSVUOSI_PATTERN, formErrorsBundle));
