...
public class HakutoiveetPhaseYhteishakuKevat {
    ...
    private static Theme createHakutoiveetTheme(final FormParameters formParameters) {
        ...
        PreferenceRow pr2 = createI18NPreferenceRow("preference2", "2", formParameters);
        PreferenceRow pr3 = createI18NPreferenceRow("preference3", "3", formParameters);
        PreferenceRow pr4 = createI18NPreferenceRow("preference4", "4", formParameters);
        PreferenceRow pr5 = createI18NPreferenceRow("preference5", "5", formParameters);
    ...
    public static PreferenceRow createI18NPreferenceRow(final String id, final String title, final FormParameters formParameters) {
        ...
        pr.addChild(createSoraQuestions(id, formParameters),
                ...
                createUrheilijalinjaRule(id, formParameters),
    ...
    public static Element createUrheilijalinjaRule(final String index, final FormParameters formParameters) {
    ...
    public static Element createKaksoistutkintoQuestions(final String index, final FormParameters formParameters) {
