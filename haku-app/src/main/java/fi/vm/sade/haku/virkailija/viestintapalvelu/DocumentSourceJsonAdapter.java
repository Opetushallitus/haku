...
public class DocumentSourceJsonAdapter implements JsonSerializer<DocumentSource>, JsonDeserializer<DocumentSource> {

	@Override
	public DocumentSource deserialize(JsonElement json, Type type, JsonDeserializationContext context) 
	...
	@Override
	public JsonElement serialize(DocumentSource documentSource, Type type, JsonSerializationContext context) {
