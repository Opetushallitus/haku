virkailija = initSelectors({
    ...
    searchPreferenceEligiblity: "#preference-eligibility",
    searchPreferenceEligibilitySelect: "#preference-eligibility-select",
    searchPreferenceEligibilitySelected: "#preference-eligibility option:selected",
