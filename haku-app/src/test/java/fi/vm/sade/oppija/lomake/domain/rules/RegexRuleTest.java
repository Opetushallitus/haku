...
public class RegexRuleTest {
    ...
    @Test
    public void testEvaluateMatch() throws Exception {
        assertTrue(RegexRule.evaluate("010188-123X", PATTERN_MALE));
    }

    @Test
    public void testEvaluateNotMatch() throws Exception {
        assertFalse(RegexRule.evaluate("010188-124X", PATTERN_MALE));
    }
