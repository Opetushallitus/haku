package fi.vm.sade.oppija.hakemus;
...
import fi.vm.sade.oppija.hakemus.it.dao.impl.ApplicationOidDAOMongoImpl;
import fi.vm.sade.oppija.lomake.service.SHA2Encrypter;
