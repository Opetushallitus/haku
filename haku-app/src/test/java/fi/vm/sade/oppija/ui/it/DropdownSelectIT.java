...
public class DropdownSelectIT extends AbstractFormTest {
    ...
    public void init() throws IOException {
        final DropdownSelect select = new DropdownSelect("select", createI18NAsIs("foo"));
        select.addOption("value1", createI18NAsIs("title"), "select");
        select.addOption("value2", createI18NAsIs("title2"), "select2");
