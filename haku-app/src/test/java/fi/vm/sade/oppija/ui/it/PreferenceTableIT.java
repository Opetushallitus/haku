...
public class PreferenceTableIT extends AbstractFormTest {
    ...
    public void init() throws IOException {
        ...
        final PreferenceRow row = new PreferenceRow("r1", createI18NText("Hakutoive 1"),
                createI18NText("Tyhjennä"), createI18NText("Koulutus"), createI18NText("Opetuspiste"),
                createI18NText("Koulutukseen sisältyvät koulutusohjelmat"), "Valitse koulutus");
        final PreferenceRow row2 = new PreferenceRow("r2", createI18NText("Hakutoive 2"), createI18NText("Tyhjennä"),
                createI18NText("Koulutus"), createI18NText("Opetuspiste"),
                createI18NText("Koulutukseen sisältyvät koulutusohjelmat"), "Valitse koulutus");
        table.addChild(row);
        table.addChild(row2);
